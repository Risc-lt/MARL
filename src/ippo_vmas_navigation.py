"""IPPO + VMAS Navigation — phase-2 baseline runner.

Mirrors src/ippo_vmas_balance.py. Parameterised by --seed so different seeds
write to isolated save folders.
"""
import sys
...
if __name__ == "__main__":
    ...
    config.render = False
    save_folder = Path(__file__).resolve().parents[1] / "results" / f"ippo_vmas_navigation_seed{args.seed}"
